...
df2 =pd.read_excel('C:\\Users\\Deep\\Desktop\\user.xlsx',header=0)
...
#    window.geometry('1366x768')
    ...
    window.geometry('%dx%d+%d+%d' %(w, h, x, y))
    window.resizable(True, True)
    window.configure(background="#80ffcc")
                     
def createWindow2(window):
#    window.geometry('1366x768')
    w = 1366
    h = 768
    ws = home.winfo_screenwidth()     # width for the window size of current device
    ...
    window.geometry('%dx%d+%d+%d' %(w, h, x, y))
    window.resizable(True, True)
    window.configure(background="#ffff33")
                     
def createWindow3(window):
#    window.geometry('1366x768')
    w = 1366
    h = 768
    ws = home.winfo_screenwidth()     # width for the window size of current device
...
def saveStudent():
    try:
      conn = pymysql.connect(user="root", password="", host="localhost",database="edumate")
      cur = conn.cursor()
...
#    photo=PhotoImage(file="C:\\Users\\Mehul Gaglani\\Downloads\\mobile1.png")
#    label=Label(backtohome,borderwidth=0,image=photo)
#    label.place(x=0,y=80)
    l = Label(backtohome, text="GOOGLE PLAYSTORE APP LAUNCH STUDY", width="500", height="2", font=Label_font,fg='white', bg='#174873').pack()
#
    l1 = Label(backtohome, text="Percentage download in each category", width="40", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=25, y=90)
    b1 = Button(backtohome, text="FIG 1", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig1).place(x=25, y=90)
#
    l2 = Label(backtohome, text="Number of Downloads", width="40", height="1", font=Label_font, fg='white',bg='#3399ff').place(x=25, y=140)
...
#
    l4 = Label(backtohome, text="Highest maximum average ratings", width="40", height="1", font=Label_font, fg='white',bg='#3399ff').place(x=25, y=240)
    b4 = Button(backtohome, text="FIG 4", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'),fg='white', command=fig4).place(x=25, y=240)
#
    l5 = Label(backtohome, text="Download category wise over period", width="40", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=25, y=290)
    b5 = Button(backtohome, text="FIG 5", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'),fg='white', command=fig5).place(x=25, y=290)
#
    l6 = Label(backtohome, text="Downloads over period of three years", width="40", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=25, y=340)
    b6 = Button(backtohome, text="FIG 6", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'),fg='white', command=fig6).place(x=25, y=340)
#
    l7 = Label(backtohome, text="Android version is not an issue", width="40", height="1", font=Label_font, fg='white',bg='#3399ff').place(x=25, y=390)
    b7 = Button(backtohome, text="FIG 7", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'),fg='white', command=fig7).place(x=25, y=390)
#
    l8 = Label(backtohome, text="Most likely to be downloaded", width="40", height="1", font=Label_font, fg='white',bg='#3399ff').place(x=25, y=440)
    b8 = Button(backtohome, text="FIG 8", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'),fg='white', command=fig8).place(x=25, y=440)
#
    l9 = Label(backtohome, text="Co-relation of downloads & ratings", width="40", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=25, y=490)
    b9 = Button(backtohome, text="FIG 9", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'),fg='white', command=fig9).place(x=25, y=490)
#
    l10 = Label(backtohome, text="Qualifies as teen versus mature 17+.", width="40", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=25, y=540)
...
#
    l11 = Label(backtohome, text="Year with highest no of install for each app", width="50", height="1",font=Label_font, fg='white', bg='#3399ff').place(x=650, y=90)
    b11 = Button(backtohome, text="FIG 11", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig11).place(x=650, y=90)
#
    l12 = Label(backtohome, text="Generate most positive & negative sentiments", width="50", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=650, y=140)
    b12 = Button(backtohome, text="FIG 12", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig12).place(x=650, y=140)
#
    l13 = Label(backtohome, text="Relation between Sentiment-polarity & subjectivity ", width="50", height="1",font=Label_font, fg='white', bg='#3399ff').place(x=650, y=190)
    b13 = Button(backtohome, text="FIG 13", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig13).place(x=650, y=190)
#
    l14 = Label(backtohome, text="Reviews categorized as positive,negative & neutral", width="50", height="1",font=Label_font, fg='white', bg='#3399ff').place(x=650, y=240)
    b14 = Button(backtohome, text="FIG 14", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig14).place(x=650, y=240)
#
    l15 = Label(backtohome, text="Advisable to launch app like 10 Best foods for you?", width="50", height="1",font=Label_font, fg='white', bg='#3399ff').place(x=650, y=290)
    b15 = Button(backtohome, text="FIG 15", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig15).place(x=650, y=290)
#
    l16 = Label(backtohome, text="Indicator to aver. downloads generated entire year?", width="50", height="1",font=Label_font, fg='white', bg='#3399ff').place(x=650, y=340)
    b16 = Button(backtohome, text="FIG 16", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig16).place(x=650, y=340)
#
    l17 = Label(backtohome, text="Size of App influence number of installs", width="50", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=650, y=390)
    b17 = Button(backtohome, text="FIG 17", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig17).place(x=650, y=390)
#
    l18 = Label(backtohome, text="Interface to add new data to both datasets", width="50", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=650, y=440)
    b18 = Button(backtohome, text="FIG 18", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig18).place(x=650, y=440)
                 
    l19 = Label(backtohome, text="Top Apps in the Playstore", width="50", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=650, y=490)
    b19 = Button(backtohome, text="FIG 19", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig19).place(x=650, y=490)
    
    l20 = Label(backtohome, text="Comparison of Apps", width="50", height="1", font=Label_font,fg='white', bg='#3399ff').place(x=650, y=540)
    b20 = Button(backtohome, text="FIG 20", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig20).place(x=650, y=540)
...
#    years = pd.to_datetime(x['Last Updated'])    
#    for i in range(len(x)):
#      x['Last Updated'].loc[i] = years[i].year
    year = [2016,2017,2018]
    downloads = {}    
...
#    print(np.corrcoef(rat['Installs'],rat['Rating']))
    ...
    ax9.set_title('APP WITH 4.1+ RATING AND 1,00,000+ DOWNLOADS')
    ax9.plot(cat,d1,color='orange')
    ax9.set_xticklabels(cat,rotation=90,ha='center')
    ax9.set_ylabel('DOWNLOADS')
    ax9.set_xlabel('CATEGORIES')
    ax9b = figure9.add_subplot(1,2,2)
    ax9b.scatter(rat['Rating'],rat['Installs'],marker="8",c='r')
    ax9b.set_ylabel("Downloads")
    ax9b.set_xlabel("Rating")
    ax9b.set_title("Correlation between Downloads and Rating is (-0.00838)")
...
def fig10():
    fig10 = Toplevel(home)
    createWindow(fig10)
#    figure = Canvas(fig10 ,width=1370, height=1000, background='lightblue')
#    figure.grid(row=10,column=0)
    ...
    cat=cat.tolist()
    x = dataframe[['Category','Installs','Year']]
#    mon = pd.to_datetime(x['Last Updated'])
#    for i in range(len(x)):
#      x['Last Updated'].loc[i] = mon[i].month
    df = x.to_dict(orient='split')
    downloads = {}
    for i in cat:
      downloads[i] = [0]*13
...
#    yr = pd.to_datetime(x['Last Updated'])
#    months = []
#    for i in range(len(x)):
#      x['Last Updated'].loc[i] = yr[i].year
#      months.append(yr[i].month)
#    x['Month'] = months
    df = x.to_dict(orient='split')
    q1=[1,2,3]
    q2=[4,5,6]
    ...
    ax11.set_ylabel("DOWNLOADS")
    ax11.set_title("Downloads in each quarter of the year")
...
def fig12():
    ...
    Label(fig12,text="App with Maximum Positive Sentiments ",width="50", height="3", font=Label1_font, fg='white', bg='#ff9900').place(x=530,y=300)
    Label(fig12,text=Max[0],width="20", height="1", font=Label1_font, fg='white', bg='#003366').place(x=530,y=400)
    Label(fig12,text=Max[1],width="20", height="1", font=Label1_font, fg='white', bg='#003366').place(x=830,y=400)
    Label(fig12,text="App with Maximum Negative Sentiments : ",width="50", height="3", font=Label1_font, fg='white', bg='#ff9900').place(x=530,y=500)
    Label(fig12,text=Min[0],width="20", height="1", font=Label1_font, fg='white', bg='#003366').place(x=530,y=600)
    Label(fig12,text=Min[1],width="20", height="1", font=Label1_font, fg='white', bg='#003366').place(x=830,y=600)
          
def fig13():
    fig13 = Toplevel(home)
    fig13.title("QUESTION 13")
    createWindow(fig13)
    Label(fig13,text="Study and find out the relation between the Sentiment-polarity and sentiment-subjectivity of all the apps ?",width="170", height="5", font=Label1_font, fg='white', bg='#800000').place(x=0, y=0)
    ...
    ax13.set_title('Relation between the Sentiment_Polarity and Sentiment_Subjectivity of all the apps')
    ax13.set_xlabel('Sentiment_Polarity')
    ax13.set_ylabel('Sentiment_Subjectivity')
...
def search_review(fig,search):
    ...
    for i in range(4):
      Label(fig, text=texts[i],width="50", height="3", font=Label1_font, fg='white', bg='#174873',anchor=W).place(x=100,y=300+c)
    ...
    ax14.set_ylabel("No. of Sentimnts")
    ax14.set_xlabel("Sentiments")
...
def fig16():
    ...
    createWindow(fig16)
    Label(fig16, text="Which month(s) of the year , is the best indicator to the avarage downloads that an app will generate over the entire year?",width="170", height="5", font=Label1_font, fg='white', bg='#800000').place(x=0, y=0)
    ...
    ax16.set_ylabel('DOWNLOADS')
    ax16.set_xlabel('MONTHS')
    ax16.set_title("Comparison of average downloads monthwise")
...
def fig17():
    ...
    ax17.set_ylabel('Number of Downloads (In 10^10 form)')
    ax17.set_xlabel('Size of App in MB')
    ax17.set_title('Trend of Size vs Downloads')  
...
def fig19():
    ...
    createWindow(fig19)
    Label(fig19, text="Top Apps in the PlayStore ",width="170", height="5", font=Label1_font, fg='white', bg='#800000').place(x=0, y=0)
...
#    print(cand_name.get()
    ...
    if(re.match(r"^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{6,})", word)):
      ...
      tm.showerror("Incorrect","Password should contain one capital,one special,one number,and of length 8 ")
      passEntry.focus_set()
...
def validate(event,input):
  if(input=='Application Name'):
    ...
    if all(x.isalnum() or x.isspace() for x in application.get()) and (len(application.get())> 0):
      ...
      tm.showerror("Invalid!","Application Name cannot be empty")
      appEntry2.focus_set()
...
def check_entry():
    ...
    appdetails = {'App': app.get(), 'Category': category.get(), 'Rating': ratings.get(), 'Reviews': reviews.get(),
                  ...
                  'Current Ver': currentver.get(), 'Android Ver': androidver.get()}
...
def new_review():
    ...
    Button(new_review, text='Submit', width=15, font=("Open Sans", 13, 'bold'), bg='brown', fg='white',command=check_review).place(x=350, y=410)
...
#    label=Label(home,borderwidth=0,image=photo)
#    label.place(x=0,y=80)
...
#
    l5 = Label(home, text="Download category wise over period", width="40", height="1", font=Label_font, fg='white',bg='#0080ff').place(x=25, y=290)
...
#
    l11 = Label(home, text="Year with highest no of install for each app", width="50", height="1",font=Label_font, fg='white', bg='#99ccff').place(x=650, y=90)
    b11 = Button(home, text="FIG 11", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig11).place(x=650, y=90)
#
    l12 = Label(home, text="Generate most positive & negative sentiments", width="50", height="1", font=Label_font,fg='white', bg='#4da6ff').place(x=650, y=140)
    b12 = Button(home, text="FIG 12", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig12).place(x=650, y=140)
#
    l13 = Label(home, text="Relation between Sentiment-polarity & subjectivity ", width="50", height="1",font=Label_font, fg='white', bg='#3399ff').place(x=650, y=190)
    b13 = Button(home, text="FIG 13", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig13).place(x=650, y=190)
#
    l14 = Label(home, text="Reviews categorized as positive,negative & neutral", width="50", height="1",font=Label_font, fg='white', bg='#1a8cff').place(x=650, y=240)
    b14 = Button(home, text="FIG 14", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig14).place(x=650, y=240)
#
    l15 = Label(home, text="Advisable to launch app like 10 Best foods for you?", width="50", height="1",font=Label_font, fg='white', bg='#0080ff').place(x=650, y=290)
    b15 = Button(home, text="FIG 15", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig15).place(x=650, y=290)
#
    l16 = Label(home, text="Indicator to aver. downloads generated entire year?", width="50", height="1",font=Label_font, fg='white', bg='#0073e6').place(x=650, y=340)
    b16 = Button(home, text="FIG 16", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig16).place(x=650, y=340)
#
    l17 = Label(home, text="Size of App influence number of installs", width="50", height="1", font=Label_font,fg='white', bg='#0066cc').place(x=650, y=390)
    b17 = Button(home, text="FIG 17", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig17).place(x=650, y=390)

    l18 = Label(home, text="Interface to add new data to both datasets", width="50", height="1", font=Label_font,fg='white', bg='#0059b3').place(x=650, y=440)
    b18 = Button(home, text="FIG 18", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig18).place(x=650, y=440)

    l19 = Label(home, text="Top Apps in the Playstore", width="50", height="1", font=Label_font,fg='white', bg='#004d99').place(x=650, y=490)
    b19 = Button(home, text="FIG 19", bg="#e79700", width="5", height="1", font=("Open Sans", 13, 'bold'), fg='white',command=fig19).place(x=650, y=490)
        
    l20 = Label(home, text="Comparison of Apps", width="50", height="1", font=Label_font,fg='white', bg='#003366').place(x=650, y=540)
...
#    adjustWindow(root)
    ...
    root.geometry("{}x{}".format(600,500))    # create dimension for frame
    mainframe = Frame(root)
    mainframe.grid_size()                   # create panel like mainframe which is subpart of root
    mainframe.pack()
    ...
    email = StringVar()
    mobile = StringVar()
    candNameEntry = Entry(mainframe, width=20, textvar=cand_name)
    ...
    emailEntry = Entry(mainframe, width=20, textvar=email)
    ...
    mobileEntry = Entry(mainframe, width=20, textvar=mobile)
    ...
    passEntry = Entry(mainframe, textvar=password, show="*")
    passEntry.grid(row=5,column=1,padx=5,pady=5)
    passEntry.bind("<Return>", lambda event: validate1(event, "password"))
    passEntry.bind("<Tab>", lambda event: validate1(event, "password"))
    repassEntry=Entry(mainframe, textvar=repassword, show="*")
    repassEntry.grid(row=6,column=1,padx=5,pady=5)
    ...
    btnFrame.grid(row=11, column=1, padx=5, pady=5)
    Label(mainframe, text='Full Name:*', anchor='w').grid(row=1, column=0, padx=5, pady=5, sticky="w")
    Label(mainframe, text='Email:*', anchor='w').grid(row=3, column=0 ,padx=5, pady=5, sticky="w")
    Label(mainframe, text='Mobile Number:', anchor='w').grid(row=5, column=0 , padx=5, pady=5, sticky="w")
    Label(mainframe, text="Password:",  anchor=W).grid(row=7,column=0)
    Label(mainframe, text="Re-Password:", anchor=W).grid(row=9, column=0 , padx=5, pady=5, sticky="w")
    Label(mainframe, text='Gender:*', anchor='w').grid(row=11, column=0 , padx=5, pady=5, sticky="w")
